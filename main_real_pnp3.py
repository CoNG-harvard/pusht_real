...
import pygame
from utils.tblock_tracker5 import TBlockTracker
...
try:
    while True:
        ...
        corners = tracker.detect_corners(color_image.copy())
        obs_candidate = None
        if corners is not None:
            ...
            predicted = np.array([tblk_env[0], tblk_env[1], tblk_env[2]], dtype=np.float32)
